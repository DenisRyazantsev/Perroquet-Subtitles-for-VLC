...
1. Refactor [perroquet.lua](perroquet.lua) (split on the classes, apply MVVM pattern or another).
2. Add tests.
3. Refactor UI (make UI as part of main screen, remove unnecessary elements).
4. Add support for *.str extension.
5. Add support for subtitles from the MKV video.
6. Add support hot keys.
7. Shrink README.md.
8. Make release 2.0.0.
